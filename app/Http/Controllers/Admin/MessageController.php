...
class MessageController extends Controller {
    ...
    public function getSearch($q = null) {
        ...
        return view('admin.pages.messages.templates.message-table', compact('messages'))->render();
    }
    ...
    public function postAction($action, Request $r) {
        ...
        switch ($action) {
            ...
            case 'deleted':
                ...
                break;
            default :
                $data = ['status' => 'error', 'title' => 'error in operation', 'msg' => 'unsupported operation '];
                return $data;
        }
        ...
        if ($r->has('ids')) {
            ...
            $data = ['status' => 'warning',
                'title' => 'error',
                'msg' => 'please select one item at least'];
        }
