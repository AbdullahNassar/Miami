    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="{{route('admin.login')}}">
                <img src="{{asset('assets/admin/layouts/layout2/img/logo-big-white.png')}}" style="height: 17px;" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form " action="{{ route('admin.login') }}" method="post" id="head-log-form">
                {{ csrf_field() }}
        ...
        <div class="copyright hide"> 2017 By Upureka </div>
        <!-- END LOGIN -->
        <!--[if lt IE 9]>
