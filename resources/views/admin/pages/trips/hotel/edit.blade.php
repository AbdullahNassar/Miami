            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plane"></i>Edit {{$t->lang}} Trip</div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <br />
                        <!-- BEGIN FORM-->
                        <form action="{{route('admin.hotelUpdate',['id'=>$t->trip_id])}}" method="POST" enctype="multipart/form-data" class="form-horizontal" onsubmit="return false" >
                            {!! csrf_field() !!}
                                ...
                                <div class="form-group col-sm-6 col-md-6">
                                    @foreach($images as $image)
                                        <div class="col-md-4 col-sm-4 col-xs-12 ajax-target">
                                            ...
                                            <button type="button" data-url="{{ route('admin.hotel.images.delete' ,['trip_id' => $t->id , 'image_id' => $image->id ]) }}" class="ajax-delete btn btn-warning">
