<div id="edit" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('admin.hotelPriceUpdate')}}" enctype="multipart/form-data" method="post" onsubmit="return false;">
                {!! csrf_field() !!}
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-sm-6 date-time ">
                                ...
                                <div class="col-md-9 col-sm-6">
                                    <input data-token="{!! csrf_token() !!}" class="form-control form-control-inline input-circle input-medium date-picker date" id="datePricker2" data-url="{{route('admin.hotelPrice')}}" name="date" type="text" >
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn green input-circle addBTN">Edit price</button>
                </div>
            </form>
        </div>
    </div>
